function [filtration, Pfiltration, K] = kalmanFilterBiased(T, len, Xmeasurements, sigma_a_sqr, sigma_eta_sqr, Pinitial, q)
...
for i = 2:len
    % Prediction
    prediction(:, i) = F * filtration(:, i - 1) + G * q;
